...
<nav class="navbar navbar-expand-sm ">
     ...
     <ul class="navbar-nav">
          ...
          <li class="nav-item">
               <a class="nav-link" href="http://localhost/WorkList/App/pages/Chat/practice.php">Register</a>
          </li>
       
          <li class="nav-item">
               <a class="nav-link" href="http://localhost/WorkList/App/pages/Chat/chatroom.php">Chat</a>
          </li>
          <li class="nav-item">
               <a class="nav-link" href="http://localhost/WorkList/App/pages/contact.php">Contact</a>
          </li>
     </ul>
</nav>
</div>
